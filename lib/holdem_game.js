...
Parameters:
- casino: the Casino server instance
- typeid: the game type ID
- roomid: the room ID
- options: game options object with the following properties:
    - max_seats: maximum number of seats at the table
    - no_joker: whether jokers are used
    - no_color: array of card colors not used 
    - no_number: array of card numbers not used
    - ready_countdown: countdown in seconds for players to ready up
    - turn_countdown: countdown in seconds for a player's turn
    - limit_rule: betting limit rule - 0: limit, 1: pot limit, 2: no limit
    - limit: big blind amount
    - limit_cap: maximum bet/raise amount, -1 means no limit

Functionality:
- Keeps track of game state, players, cards, bets, etc. 
- Notifies players of game events
- Handles player actions/commands
- Determines winners and distributes pot at showdown

Game states:
- GAME_OVER: game over, waiting for new round 
- SMALL_BLIND: small blind posted
- BIG_BLIND: big blind posted
- PREFLOP: hole cards dealt, first round of betting
- FLOP: flop dealt, second round of betting
- TURN: turn dealt, third round of betting
- RIVER: river dealt, final round of betting
- SHOWDOWN: showdown, determine winner(s) and distribute pot

Betting limit rules:
- LIMIT: fixed limit betting 
- POT_LIMIT: pot limit betting
- NO_LIMIT: no limit betting
